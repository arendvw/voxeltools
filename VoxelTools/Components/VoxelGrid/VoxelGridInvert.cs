...
namespace StudioAvw.Voxels.Components.VoxelGrid
{
    ...
    public class VoxelGridInvert : GhVoxelComponent
    {
        ...
        /// </summary>
        public VoxelGridInvert()
            : base("VoxelGrid Boolean Invert", "VGInvert",
                "Invert a voxel grid",
                "Voxels", "Boolean")
        {
        }
        ...
        protected override Bitmap Icon =>
            ...
            Images.VT_GridInverse;

        /// <summary>
        /// Gets the unique ID for this component. Do not change this ID after release.
        /// </summary>
        public override Guid ComponentGuid => new Guid("{0CB9D055-2AE4-4B00-8B55-558C22175933}");
    }
}